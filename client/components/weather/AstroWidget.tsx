  ...
  return (
    <div className="grid gap-6">
      ...
      <Card className="rounded-xl border-none bg-white dark:bg-slate-900 shadow-sm overflow-hidden border border-slate-100 dark:border-white/5">
        <CardHeader className="p-6 pb-2">
           <CardTitle className="text-sm font-bold text-[#333] dark:text-white flex items-center gap-2">
              <FiSun className="text-amber-500" /> {t("sunLabel")}
           </CardTitle>
        </CardHeader>
        <CardContent className="p-6 pt-2">
           <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                 ...
                 <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">{t("sunriseLabel")}</p>
              ...
              <div className="flex items-center gap-4">
                 ...
                 <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">{t("sunsetLabel")}</p>
           ...
           <div className="bg-slate-50 dark:bg-white/5 rounded-xl p-3 border border-slate-100 dark:border-white/10 flex items-center justify-between">
              <span className="text-[10px] font-bold text-slate-500 uppercase">{t("daylightDuration")}</span>
      ...
      <Card className="rounded-xl border-none bg-white dark:bg-slate-900 shadow-sm overflow-hidden border border-slate-100 dark:border-white/5">
        <CardHeader className="p-6 pb-2">
           <CardTitle className="text-sm font-bold text-[#333] dark:text-white flex items-center gap-2">
              <FiMoon className="text-slate-400" /> {t("moonLabel")}
           </CardTitle>
        </CardHeader>
        <CardContent className="p-6 pt-2">
           <div className="flex items-center justify-between">
              <div className="space-y-4">
                 <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">{t("moonriseLabel")}</p>
                    <p className="text-lg font-black text-slate-700 dark:text-white">10:42 AM</p>
                 </div>
                 <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">{t("moonsetLabel")}</p>
                    <p className="text-lg font-black text-slate-700 dark:text-white">11:58 PM</p>
                 </div>
                 <div className="pt-2">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">{t("moonPhase")}</p>
                    <p className="text-xs font-bold text-[#004d73] dark:text-[#ffcc00]">{t("waxingGibbous")}</p>
                 </div>
              </div>
