...
export default function Pests() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card className="rounded-[2.5rem] border-primary/10 bg-white shadow-xl overflow-hidden">
        ...
        <CardContent className="p-8">
          <div className="grid gap-6 md:grid-cols-3 items-end">
            <div className="space-y-2">
              <label className="text-sm font-bold text-muted-foreground">{t('chooseCrop')}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-muted-foreground">{t('weatherCondition')}</label>
            ...
            <Button
              ...
              className="rounded-xl bg-orange-600 hover:bg-orange-700 h-14 font-black flex items-center gap-2 shadow-xl shadow-orange-500/20"
            >
