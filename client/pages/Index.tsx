      ...
      <section className="py-16 bg-muted/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Store, value: t('saathiCountValue'), label: t('saathiRetailStores'), color: "bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400", desc: t('saathiRetailDesc') },
              { icon: Globe, value: t('languagesCountValue'), label: t('localLanguages'), color: "bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400", desc: t('localLanguagesDesc') },
              { icon: TrendingUp, value: t('produceCountValue'), label: t('produceProcessed'), color: "bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400", desc: t('produceProcessedDesc') },
              { icon: Leaf, value: t('empoweredCountValue'), label: t('farmersEmpowered'), color: "bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400", desc: t('farmersEmpoweredDesc') },
            ].map((item, idx) => (
              <motion.div
                key={idx}
