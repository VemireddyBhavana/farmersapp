...
const EXPERTS = [
  { 
    id: 1, 
    name: "Dr. Aman Deep", 
    title: "Crisis Counselor & Psychologist", 
    ...
    tags: ["Life-saving", "Empathy", "24/7 Support"],
    rating: 5,
    availability: "Always Available",
    price: 0,
    description: "Detects distress signals in farmer conversations. Provides compassionate support, immediate practical steps, and crisis helpline connections. Built to address India's farmer suicide epidemic with AI-powered empathy."
  },
  { 
    id: 2, 
    name: "Er. Ramesh Varma", 
    title: "Quality Assurance Specialist", 
    specialty: "Fake Input Detector", 
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=300",
    tags: ["Fraud Protection", "Seed Quality", "Fertilizer Audit"],
    rating: 5,
    availability: "Daily, 9 AM - 6 PM",
    price: 99,
    description: "Teaches farmers to verify seeds, fertilizers, and pesticides before purchase. Prevents lakhs in losses to agricultural fraud."
  },
  { 
    id: 3, 
    name: "Dr. Sunita Rao", 
    title: "Sustainability Expert", 
    specialty: "Carbon Credits Guide", 
    image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=300",
    tags: ["New Income", "Eco-Friendly", "Global Markets"],
    rating: 4,
    availability: "Mon-Fri, 10 AM - 4 PM",
    price: 149,
    description: "Unlocks ₹7,500–₹50,000/year extra income for farmers practicing sustainable farming. Connects to global carbon markets like Boomitra."
  },
  { 
    id: 4, 
    name: "Prof. Vikram Singh", 
    title: "Export Logistics Expert", 
    specialty: "Export Quality Checker", 
    image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=300",
    tags: ["3x Income", "Global Trade", "APEDA"],
    rating: 5,
    availability: "Wed-Sun, 6-9 PM",
    price: 349,
    description: "Guides farmers to meet EU, USA, and Gulf quality standards. Earn 3× more by selling internationally via APEDA certification."
  },
  { 
    id: 5, 
    name: "Mrs. Meera Das", 
    title: "Hospitality & Agri-Business", 
    specialty: "Agri-Tourism Advisor", 
    image: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?auto=format&fit=crop&q=80&w=300",
    tags: ["Extra Income", "Farm Stay", "Education"],
    rating: 4,
    availability: "Weekends, 9 AM - 8 PM",
    price: 199,
    description: "Transforms farms into tourist destinations. Day visits, farm stays, school trips — ₹90,000+/month additional income potential."
  },
  { 
    id: 6, 
    name: "Master Subhash", 
    title: "Natural Farming Mentor", 
    specialty: "Zero Budget Farming", 
    image: "https://images.unsplash.com/photo-1621330396173-e41b1cafd17f?auto=format&fit=crop&q=80&w=300",
    tags: ["Zero Cost", "Organic", "Subhash Palekar Method"],
    rating: 5,
    availability: "Daily, 6-9 AM",
    price: 49,
    description: "Teaches natural farming methods. Eliminate fertilizer and pesticide costs using Jivamrita, Bijamrita, and natural inputs."
  },
  { 
    id: 7, 
    name: "Adv. Anjali Reddy", 
    title: "Human Rights Lawyer", 
    specialty: "Women Farmer Empowerment", 
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=300",
    tags: ["Social Justice", "Land Rights", "Loans"],
    rating: 5,
    availability: "Tue-Thu, 4-7 PM",
    price: 0,
    description: "Helps women access land rights, independent loans, and government schemes they are legally entitled to but often denied."
  },
  { 
    id: 8, 
    name: "Shri Prakash Raj", 
    title: "Revenue Department Expert", 
    specialty: "Land Dispute Mediator", 
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=300",
    tags: ["Legal Help", "Fast Track", "Mediation"],
    rating: 5,
    availability: "Mon-Sat, 9 AM - 5 PM",
    price: 249,
    description: "Guides farmers through boundary disputes, water conflicts, and tenancy issues via Revenue Department and Lok Adalat."
  },
  { 
    id: 9, 
    name: "Digital Ravi", 
    title: "Digital India Trainer", 
    specialty: "Digital Literacy Trainer", 
    image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=300",
    tags: ["Digital India", "UPI Safety", "Govt Apps"],
    rating: 5,
    availability: "Always Available",
    price: 0,
    description: "Teaches farmers how to use smartphones, UPI payments, government apps, and online platforms. Includes safety rules for UPI."
  }
];
