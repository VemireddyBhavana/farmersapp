...
import { Shield, ArrowRight, Star, TrendingUp, Cloud, Leaf, Calendar } from "lucide-react";
...
const features = [
  {
    ...
    description: "Real-time weather analysis tailored for your specific crops and region.",
    color: "bg-blue-100 text-blue-600",
  },
  {
    icon: TrendingUp,
    title: "Live Market Prices",
    description: "Get daily mandi rates for all major crops across Andhra Pradesh.",
    color: "bg-green-100 text-green-600",
  },
  {
    icon: Calendar,
    title: "Planting Calendar",
    description: "Personalized calendars for sowing, harvesting, and field preparation.",
    color: "bg-amber-100 text-amber-600",
  },
  {
    icon: Shield,
    title: "Pest Alerts",
    description: "Early warning system for pests and diseases with management advice.",
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <h1 className="text-5xl font-extrabold tracking-tight text-foreground lg:text-7xl">
                Smart Tools for <br />
                <span className="text-primary italic">KisanTech</span>
              </h1>
              <p className="max-w-xl text-lg text-muted-foreground lg:text-xl">
                Get expert AI-driven farming advice, real-time weather analytics, and smart mandi tools with KisanTech.
              </p>
