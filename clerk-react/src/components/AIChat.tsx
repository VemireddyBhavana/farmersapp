...
const AIChat = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "bot",
      content: "Namaste! I am KisanAI, your intelligent farming companion from KisanTech. How can I help you today? I can help with tractor booking, crop advice, or market rates.",
          ...
          >
            ...
            <div className="flex items-center justify-between bg-primary p-4 text-primary-foreground">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold">KisanAI Assistant</h3>
